...
export default function Payment() {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-8">
          <Button onClick={() => navigate('/dashboard')} className="mb-4 bg-green-600 text-white hover:bg-green-700">
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>We need this information for your subscription</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
