        ...
        <section className="py-20 lg:py-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-10">
              From solo freelancers to enterprise teams, Craft Proposal adapts to your business needs 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                See how Craft Proposal helps businesses win more deals
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-muted-foreground mb-10">
              Join thousands of businesses already using Craft Proposal to win more deals and grow faster.
            </p>
