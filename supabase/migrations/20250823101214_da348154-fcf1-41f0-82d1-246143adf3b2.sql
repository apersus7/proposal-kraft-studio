...
('Creative Agency Proposal', 'Perfect for creative agencies and design studios', null, '{"sections": [{"type": "hero", "title": "Creative Partnership Proposal", "subtitle": "Let\\'s create something amazing together"}, {"type": "portfolio", "title": "Our Work", "content": "{{portfolio_items}}"}, {"type": "approach", "title": "Our Approach", "content": "{{methodology}}"}, {"type": "timeline", "title": "Project Timeline", "content": "{{project_phases}}"}, {"type": "investment", "title": "Investment & Terms", "content": "{{pricing_breakdown}}"}]}', true),
